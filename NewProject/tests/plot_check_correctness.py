...
ax.imshow(image_cpu, cmap="binary")
...
fig, ax = plt.subplots(figsize=(20,20))
ax.imshow(image_gpu_naive, cmap="binary")
...
fig, ax = plt.subplots(figsize=(20,20))
ax.imshow(image_gpu_shared, cmap="binary")
...
fig, ax = plt.subplots(figsize=(20,20))
ax.imshow(image_gpu_const, cmap="binary")
...
fig, ax = plt.subplots(figsize=(20,20))
ax.imshow(image_gpu_sep, cmap="binary")
...
fig, ax = plt.subplots(figsize=(20,20))
ax.imshow(image_gpu_tiling, cmap="binary")
